...
@Slf4j
@Component
public class InterviewScriptWorkflowDispatcher {
    ...
    public InterviewScriptWorkflowDispatcher(
    ...
    private void dispatchClaimed(Long sessionId, UUID processingToken) {
        ...
        try {
            ...
            log.warn(
                    "Interview AI queue rejected work; database recovery will retry: sessionId={}",
                    sessionId);
        }
    }
    ...
    private void scheduleRecovery(Long sessionId, Instant retryAt) {
        try {
            ...
            log.warn(
                    "Interview retry trigger was rejected; periodic recovery will retry: sessionId={}",
                    sessionId);
        }
    }
}
